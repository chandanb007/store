    ...
    return (
      <div className="max-w-xl mx-auto px-4 py-24 text-center space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="font-serif text-2xl font-bold dark:text-stone-100">Your Sieve of Treasures is Empty</h1>
          <p className="text-stone-404 text-stone-400 text-xs leading-relaxed max-w-sm mx-auto">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 space-y-4">
                ...
                >
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto mt-2 sm:mt-0 pt-4 sm:pt-0 border-t border-stone-50 sm:border-0">
                    ...
                    <div className="text-right min-w-24">
                      <span className="block text-sm font-bold text-stone-900 dark:text-stone-100 animate-fade-in font-sans">
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg text-stone-404 text-stone-400 hover:text-rose-500 hover:bg-stone-50 dark:hover:bg-stone-950 transition-colors cursor-pointer"
          ...
          <Link
            to="/shop"
            className="text-xs font-bold text-gold-600 dark:text-gold-400 hover:text-gold-850 transition-colors uppercase tracking-wider flex items-center gap-1 inline-block py-2"
          >
        ...
        <div className="space-y-6">
          {/* Summary Card */}
          <div className="bg-white dark:bg-stone-900 border border-stone-150/45 dark:border-stone-850 p-6 rounded-2xl shadow-sm space-y-6">
            <h2 className="font-serif text-lg font-bold text-stone-900 dark:text-stone-105 border-b border-stone-100 dark:border-stone-850 pb-3 font-sans">
              Honorary Receipt
            </h2>
            ...
            <button
              ...
              className="w-full py-3.5 bg-gold-505 bg-gold-500 hover:bg-gold-600 active:scale-95 text-stone-950 font-bold rounded-xl text-xs uppercase tracking-widest transition-all cursor-pointer block text-center shadow-md font-sans"
            >
              Secure Checkout
            </button>
          </div>
          ...
          <div className="bg-white dark:bg-stone-900 border border-stone-150/45 dark:border-stone-850 p-6 rounded-2xl shadow-sm space-y-4">
            <h4 className="font-serif font-bold text-stone-900 dark:text-stone-101 text-sm flex items-center gap-2">
