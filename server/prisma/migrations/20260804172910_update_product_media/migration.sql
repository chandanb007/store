...
INSERT INTO "new_Media" ("altText", "createdAt", "fileName", "fileSize", "id", "mimeType", "updatedAt") SELECT "altText", "createdAt", "fileName", "fileSize", "id", "mimeType", "updatedAt" FROM "Media";
DROP TABLE "Media";
...
CREATE TABLE "new_ProductMedia" (
    ...
    CONSTRAINT "ProductMedia_mediaId_fkey" FOREIGN KEY ("mediaId") REFERENCES "Media" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_ProductMedia" ("createdAt", "id", "isPrimary", "mediaId", "productId", "sortOrder") SELECT "createdAt", "id", "isPrimary", "mediaId", "productId", "sortOrder" FROM "ProductMedia";
DROP TABLE "ProductMedia";
ALTER TABLE "new_ProductMedia" RENAME TO "ProductMedia";
